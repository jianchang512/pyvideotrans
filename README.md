...
【批量将音频视频转为字幕】将音频、视频文件中的人类说话声，识别为文字并导出为srt字幕文件

【批量将字幕配音】根据本地已有的srt字幕文件创建配音，支持单个或批量字幕

【批量翻译字幕】将一个或多个srt字幕文件翻译为其他语言的字幕文件

【批量合并视频和音频】批量将视频文件和音频文件一一对应合并

【批量合并视频和srt字幕】批量将视频文件srt字幕文件一一对应合并

【批量为视频添加图片水印】批量将视频文件中嵌入图片水印

【批量从视频中提取音频】从视频中分离为音频文件和无声视频
