...
from videotrans.tts import run as run_tts, CLONE_VOICE_TTS, CHATTERBOX_TTS, COSYVOICE_TTS, F5_TTS, EDGE_TTS, AZURE_TTS,  INDEX_TTS, VOXCPM_TTS, SPARK_TTS, DIA_TTS, GPTSOVITS_TTS,QWEN3LOCAL_TTS
...
class TransCreate(BaseTask):
    ...
    def _tts(self,daz_json=None) -> None:
        ...
        for i, it in enumerate(subs):
            ...
            # 是克隆
            if voice == 'clone' and self.cfg.tts_type in [COSYVOICE_TTS, CLONE_VOICE_TTS, F5_TTS,INDEX_TTS,VOXCPM_TTS,SPARK_TTS,DIA_TTS,CHATTERBOX_TTS,GPTSOVITS_TTS,QWEN3LOCAL_TTS]:
