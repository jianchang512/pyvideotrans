...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    fn_subtitlescover
        ...
        self.actionrecognapi.triggered.connect(recognapi.open)
        ...
        self.actionopenaitts_key.triggered.connect(openaitts.open)
        self.actionopenairecognapi_key.triggered.connect(openairecognapi.open)
        ...
        self.actionformatcover.triggered.connect(fn_formatcover.open)
        self.actionsubtitlescover.triggered.connect(fn_subtitlescover.open)
