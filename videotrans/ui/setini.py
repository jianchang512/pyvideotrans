...
class Ui_setini(object):
    def setupUi(self, setini):
        ...
        self.titles = {
            ...
            "vad": "启用VAD",
            "overall_silence": "最小静音片段",
            "overall_maxsecs": "语句最大持续秒数",
            "overall_threshold": "VAD阈值",
            "overall_speech_pad_ms": "VAD pad值",
            "voice_silence": "均等分割时静音片段",
            "interval_split": "均等分割时片段时长",
        ...
        self.heads = {
            ...
            "model_list": "语音识别控制",
            "fontsize": "硬字幕样式",
            "trans_thread": "翻译和配音控制",
            "chattts_voice": "其他"
        }
        if config.defaulelang != 'zh':
            self.notices = {
                "lang": "Set the language for the software interface, a restart is required after changing.",
                "countdown_sec": "Countdown seconds when paused.",
                "backaudio_volume": "Background audio volume as a multiple of the original.",
                "loop_backaudio": "Whether to loop the background audio if it's shorter than the video, default is no.",
                "ai302_models": "Enter the model names for translation used by 302.ai, separated by English commas.",
                "ai302tts_models": "Enter the model names for dubbing used by 302.ai, separated by English commas.",
                "chatgpt_model": "Selectable chatGPT models, separated by English commas.",
                "gemini_model": "List of Gemini models.",
                "azure_model": "Selectable models, separated by English commas.",
                "localllm_model": "Selectable models, separated by English commas.",
                "zijiehuoshan_model": "Enter the name of the inference access point created in Byte Volcano Ark. See the creation method at the provided link.",
                "crf": "Control the loss during video transcoding, 0=lossless, 51=max loss, default is 13.",
                "cuda_qp": "Whether to use qp instead of crf on NVIDIA cuda, true=yes, false=no.",
                "preset": "Controls the output video quality and size, faster means lower quality.",
                "ffmpeg_cmd": "Custom ffmpeg command parameters, added in the second-to-last position, e.g., -bf 7 -b_ref_mode middle.",
                "video_codec": "Use libx264 encoding or libx265 encoding, 264 for better compatibility, 265 for higher compression and clarity.",
                "audio_rate": "Maximum audio speedup factor, default is 3, set a number between 1-100, e.g., 3 for 3x speed.",
                "video_rate": "Video slow-motion multiplier: a number greater than 1, 0 or 1 means no slow motion.",
                "remove_silence": "Whether to remove silence at the end of the dubbing, true=remove, false=do not remove.",
                "remove_srt_silence": "Whether to remove silence when the original subtitle duration is longer than the dubbed duration, e.g., original 5s, dubbed 3s, whether to remove the 2s silence, true=remove, false=do not remove.",
                "remove_white_ms": "Remove silence between two subtitles in milliseconds, e.g., 100ms, if the interval is greater than 100ms, it will be removed, -1=remove completely.",
                "force_edit_srt": "true=Force edit subtitle timing to match sound, false=Do not edit, keep original subtitle timing, not editing may cause mismatch between subtitles and sound.",
                "vad": "Enable VAD when using the faster-whisper subtitle overall recognition mode.",
                "overall_silence": "Minimum silence segment in milliseconds, default is 250ms.",
                "overall_maxsecs": "Maximum duration of speech segments in seconds.",
                "overall_threshold": "VAD threshold value.",
                "overall_speech_pad_ms": "VAD padding value in milliseconds.",
                "voice_silence": "Silence segments in equal division mode.",
                ...
                "cuda_com_type": "Cuda data type in faster mode, int8=less resource consumption, faster, lower precision, float32=more resource consumption, slower, higher precision, int8_float16=device selects.",
                "initial_prompt_zh": "Prompt sent to the whisper model.",
                "whisper_threads": "CPU processes when recognizing subtitles in faster mode.",
                "whisper_worker": "Number of working processes when recognizing subtitles in faster mode.",
                "beam_size": "Accuracy adjustment when recognizing subtitles, 1-5, 1=lowest VRAM consumption, 5=highest VRAM consumption.",
                "best_of": "Accuracy adjustment when recognizing subtitles, 1-5, 1=lowest VRAM consumption, 5=highest VRAM consumption.",
                "temperature": "0=Less GPU resource usage but slightly worse effect, 1=More GPU resource usage with better effect.",
                "condition_on_previous_text": "true=More GPU resource usage for better effect, false=Less GPU resource usage with slightly worse effect.",
                "fontsize": "Hard subtitle font size in pixels.",
                "fontname": "Font name for hard subtitles.",
                "fontcolor": "Set font color, note the 6 characters after &H, each pair represents BGR color, i.e., 2 blue/2 green/2 red, which is the reverse of common RGB colors.",
                "fontbordercolor": "Set font border color, note the 6 characters after &H, each pair represents BGR color, i.e., 2 blue/2 green/2 red, which is the reverse of common RGB colors.",
                "subtitle_bottom": "Subtitles are positioned at the bottom of the video by default, set a positive number here to represent how much the subtitles are moved up, note the maximum cannot be greater than (video height - 20), to keep at least 20 height for displaying subtitles, otherwise, subtitles will not be visible.",
                "cjk_len": "Number of characters per line for CJK hard subtitles, more than this will wrap.",
                "other_len": "Line wrap length for other languages in hard subtitles, more than this number of characters will wrap.",
                "zh_hant_s": "Force traditional Chinese subtitles to be converted to simplified Chinese.",
                "trans_thread": "Number of subtitle lines translated simultaneously.",
                "retries": "Number of retries when translation fails.",
                "translation_wait": "Pause time after each translation in seconds, to limit request frequency.",
                "dubbing_thread": "Number of subtitle lines dubbed simultaneously.",
                "azure_lines": "Batch line count for azureTTS.",
                "chattts_voice": "chatTTS voice tone value."
            }
            self.heads = {
                "lang": "General Settings",
                "ai302_models": "AI Model Related",
                "crf": "Video Output Quality",
                "vad": "VAD Related",
                "model_list": "Speech Recognition Control",
                "fontsize": "Hard Subtitle Style",
                "trans_thread": "Translation and Dubbing",
                "chattts_voice": "Others"
            }
            self.titles = {
