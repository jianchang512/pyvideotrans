...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.geshi_mp4.setText(box_lang.get("Convert mp4->"))
        self.geshi_avi.setText(box_lang.get("Convert avi->"))
        self.geshi_mov.setText(box_lang.get("Convert mov->"))
        self.geshi_wav.setText(box_lang.get("Convert wav->"))
        self.geshi_mp3.setText(box_lang.get("Convert mp3->"))
        self.geshi_aac.setText(box_lang.get("Convert aac->"))
        self.geshi_m4a.setText(box_lang.get("Convert m4a->"))
        self.geshi_flac.setText(box_lang.get("Conver flac->"))
        self.geshi_result.setPlaceholderText(box_lang.get("The conversion result is displayed here"))
        self.geshi_output.setText(box_lang.get("Open output dir"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), box_lang.get("Audio and video format conversion"))
        ...
        self.daochu.setText(box_lang.get("export.."))
