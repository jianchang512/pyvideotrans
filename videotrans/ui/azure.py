...
class Ui_azureform(object):
    ...
    def retranslateUi(self, azureform):
        ...
        azureform.setWindowTitle(_translate("azureform", "Azure"))
        self.label_3.setText(_translate("azureform", "Azure Model"))
        self.azure_template.setPlaceholderText(_translate("azureform", "prompt"))
        self.label_4.setText(_translate("azureform", "{lang} don\'t remove"))
        self.set_azure.setText(_translate("azureform", "OK"))
        self.azure_api.setPlaceholderText(_translate("azureform", "api url"))
        self.azure_key.setPlaceholderText(_translate("azureform", "secret key"))
        self.label.setText(_translate("azureform", "Azure API URL"))
        self.label_2.setText(_translate("azureform", "Azure  Key "))
