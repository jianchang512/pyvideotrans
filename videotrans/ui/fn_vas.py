...
class Ui_fn_vas(QtWidgets.QWidget):
    ...
    def setupUi(self, vasrt):
        ...
        self.ysphb_stopbtn = QtWidgets.QPushButton()
        self.ysphb_stopbtn.setMinimumSize(QtCore.QSize(150, 30))
        self.ysphb_stopbtn.setObjectName("ysphb_stopbtn")
        self.ysphb_stopbtn.setDisabled(True)
    ...
    def retranslateUi(self):
        ...
        self.ysphb_stopbtn.setText(tr("stopImmediately"))
