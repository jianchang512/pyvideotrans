...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 896, 367))
...
"Choose only one of the two options"))
        ...
        self.action_tiquzimu_no.setText(_translate("MainWindow", "Video Subtitle Extract"))
        ...
        self.action_zimu_video.setText(_translate("MainWindow", "Subtitle video merging"))
        self.action_zimu_video.setToolTip(_translate("MainWindow", "Embed locally existing SRT subtitles into the video"))
        self.action_zimu_peiyin.setText(_translate("MainWindow", "Srt creation dubbing"))
        ...
        self.action_yuyinhecheng.setText(_translate("MainWindow", "From Text to speech"))
        self.action_yuyinhecheng.setToolTip(_translate("MainWindow", "Generate audio WAV from text or SRT subtitle files"))
        self.action_tiquzimu.setText(_translate("MainWindow", "Extract Srt translate"))
        ...
        self.action_yinshipinfenli.setText(_translate("MainWindow", "Video audio separation"))
        self.action_yinshipinfenli.setToolTip(_translate("MainWindow", "Separate audio and silent videos from videos"))
        self.action_yingyinhebing.setText(_translate("MainWindow", "Video subtitle merging"))
        self.action_yingyinhebing.setToolTip(_translate("MainWindow", "Merge audio, video, and subtitles into one file"))
        self.action_geshi.setText(_translate("MainWindow", "File format conversion"))
