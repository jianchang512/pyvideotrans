...
class Ui_chatgptform(object):
    ...
    def retranslateUi(self, chatgptform):
        ...
        self.chatgpt_api.setPlaceholderText(_translate("chatgptform", "官方api或第三方接口网址，默认官方 https://chat.openai.com"))
        self.chatgpt_key.setPlaceholderText(_translate("chatgptform", "密钥key"))
