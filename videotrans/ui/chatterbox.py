...
class Ui_chatterboxform(object):
    def setupUi(self, chatterboxform):
        ...
        label_github = QLabel()
        label_github.setText('需要安装并启动 https://github.com/jianchang512/chatterbox-api 才可使用' if config.defaulelang=='zh' else 'You need to install and start https://github.com/jianchang512/chatterbox-api before you can use it')
