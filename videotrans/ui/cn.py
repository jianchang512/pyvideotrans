...
"两者只可选其一"))
        ...
        self.action_biaozhun.setText(_translate("MainWindow", "标准全功能模式"))
        self.action_biaozhun.setToolTip(_translate("MainWindow", "显示全部选项，进行视频翻译和配音"))
        self.action_tiquzimu.setText(_translate("MainWindow", "提取字幕并翻译"))
        self.action_tiquzimu.setToolTip(_translate("MainWindow", "从本地视频中提取出原始语言的srt字幕并翻译为指定语言"))
        self.action_zimu_video.setText(_translate("MainWindow", "字幕和视频合并"))
        self.action_zimu_video.setToolTip(_translate("MainWindow", "将本地已有的srt字幕嵌入视频中"))
        self.action_zimu_peiyin.setText(_translate("MainWindow", "为字幕创建配音"))
        self.action_zimu_peiyin.setToolTip(_translate("MainWindow", "本地已有的srt字幕生成配音wav文件"))
        self.action_yuyinshibie.setText(_translate("MainWindow", "音视频识别文字"))
        self.action_yuyinshibie.setToolTip(_translate("MainWindow", "将音频或视频中的声音识别后输出srt文字"))
        self.action_yuyinhecheng.setText(_translate("MainWindow", "将文字合成语音"))
        self.action_yuyinhecheng.setToolTip(_translate("MainWindow", "将文字或srt字幕文件生成音频wav"))
        self.action_tiquzimu_no.setText(_translate("MainWindow", "提取字幕不翻译"))
        self.action_tiquzimu_no.setToolTip(_translate("MainWindow", "从本地视频中提取出原始语言的srt字幕文件"))
        self.action_yinshipinfenli.setText(_translate("MainWindow", "从视频分离音频"))
        self.action_yinshipinfenli.setToolTip(_translate("MainWindow", "从视频中分离出音频和无声视频"))
        self.action_yingyinhebing.setText(_translate("MainWindow", "音视频字幕合并"))
        self.action_yingyinhebing.setToolTip(_translate("MainWindow", "将音频、视频、字幕合并为一个文件"))
        self.action_geshi.setText(_translate("MainWindow", "音视频格式转换"))
