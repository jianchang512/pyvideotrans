...
from PySide6.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QComboBox, QPushButton, QPlainTextEdit, \
...
class Worker(QThread):
    ...
    def __init__(self, device_idx=None, parent=None):
