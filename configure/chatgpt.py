...
class Ui_chatgptform(object):
    def setupUi(self, chatgptform):
        ...
        self.chatgpt_api.setGeometry(QtCore.QRect(130, 10, 451, 35))
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 111, 35))
        self.label.setMinimumSize(QtCore.QSize(0, 35))
        self.label.setObjectName("label")
        self.chatgpt_key = QtWidgets.QLineEdit(chatgptform)
        self.chatgpt_key.setGeometry(QtCore.QRect(130, 60, 451, 35))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 60, 111, 35))
    ...
    def retranslateUi(self, chatgptform):
        ...
        self.chatgpt_api.setPlaceholderText(_translate("chatgptform", "https://chat.openai.com"))
        self.label.setText(_translate("chatgptform", "ChatGPT API"))
