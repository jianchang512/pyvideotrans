...
parser.add_argument("-dr", "--default_refer_path", type=str, default=os.path.join('./',"wavs/10.wav"), help="默认参考音频路径")
...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language,  top_k=20, top_p=0.6, temperature=0.6, ref_free = False):
...
def get_tts_wav11(ref_wav_path, prompt_text, prompt_language, text, text_language):
    t0 = ttime()
    prompt_text = prompt_text.strip("\n")
