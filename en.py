...
"background-color: rgba(255, 255, 255, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.insert_subtitle.setToolTip(_translate("MainWindow", "If you do not select it, subtitles will not be embedded. Only an SRT file will be generated in the original video directory."))
        self.insert_subtitle.setText(_translate("MainWindow", "Embedding subtitles.?"))
