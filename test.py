...
#     raw_basename=os.path.basename(name)
#     raw_noextname,ext=os.path.splitext(raw_basename)
#     raw_dirname=os.path.dirname(name)
#     obj={
#         "raw_name":name,
#         # 原始视频所在原始目录
#         "raw_dirname":raw_dirname.replace('\\','/'),
#         # 原始视频原始名字带后缀
...
#         obj['noextname']=h.hexdigest()
#         obj['basename']=f'{obj["noextname"]}.{obj["raw_ext"]}'
#         obj['dirname']=config.TEMP_DIR+f"/{obj['noextname']}"
#         obj['dirname']=config.TEMP_DIR+f"/{obj['noextname']}"
#         # 目标存放位置，完成后再复制
#         obj['linshi_output']=config.TEMP_DIR+f'/{obj["noextname"]}/out'
#         os.makedirs(obj['linshi_output'],exist_ok=True)
#
#     return obj
